...
public class NyfalisUnitType extends UnitType {
    ...
    public class NyfalisWeapon extends Weapon {
        boolean boostShoot = true, groundShoot = true;
...
//        boolean can =  !unit.disarmed && !(unit.type.canBoost && unit.isFlying() && !boostShoot) && (!unit.type.canBoost && !unit.isFlying() && !groundShoot);!(unit.type.canBoost && unit.isFlying() && !boostShoot) && (!unit.type.canBoost && !unit.isFlying() && !groundShoot);
